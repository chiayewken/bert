...
# class XnliProcessor(DataProcessor):  # new
...
# class MnliProcessor(DataProcessor):  # new
...
# class MrpcProcessor(DataProcessor):  # new
...
def metric_fn(per_example_loss, label_ids, logits):  # new
